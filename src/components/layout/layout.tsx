...
interface LayoutProps {
  ...
  activeSection: "home" | "accommodation" | "wedding" | "rsvp" | "registry" | "activities" | "faqs" | "info";
  title?: string;
}
  ...
  return (
    <>
      <div className='body'>
        ...
        { isMobile && <Dropdown toggle={() => setIsMenuOpen(!isMenuOpen)} isOpen={isMenuOpen}/>}
        <div className={`menu ${isMenuOpen || !isMobile ? 'show' : 'hide'}`}>
            ...
            {/* <MenuItem activeSection={activeSection} section= 'info' title='Information' urlPath='/information'/> */}
