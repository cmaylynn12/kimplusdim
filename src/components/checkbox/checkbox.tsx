    ...
    <label htmlFor={name} className="label">
      <svg width="43" height="43" viewBox="0 0 90 90">
        ...
        <g transform="translate(0,-952.36218)">
          <path d="m 13,983 c 33,6 40,26 55,48 " stroke="black" stroke-width="3" className="path1" fill="none" />
          <path d="M 75,970 C 51,981 34,1014 25,1031 " stroke="black" stroke-width="3" className="path1" fill="none" />
        </g>
      </svg>
      <span>{name}</span>
    </label>
